...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val panelBg = Color.parseColor("#E6101418")
    ...
    /** Draws truly edge-to-edge: without this, Android reserves space for the system
     *  status/nav bars even under a translucent window, leaving a visible gap around
     *  the screen edges. */
